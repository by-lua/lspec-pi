...
> A 5-phase SDD workflow for **new AND existing projects**: Discovery → Feature-Clarify → Specify → Design → Tasks → Execute. Also: analyze existing code (`/skill:l-spec-map`), ask questions (`/skill:l-spec-ask`), and fix bugs (`/skill:l-spec-bugfix`).
...
|---------|-----------------|
| [Instalação rápida](#instalação-rápida) | Instalar, atualizar, desinstalar |
...
| [Desinstalar](#desinstalar) | Remoção limpa |
...
Instala em `~/.pi/agent/skills/l-spec*/`.
...
Desinstala a versão anterior (skills + prompts) e instala a mais recente.
...
```
lspec-pi/
├── install.sh                          # instalar (curl | bash)
├── update.sh                           # desinstalar + instalar (curl | bash)
├── uninstall.sh                        # desinstalar (curl | bash)
├── README.md                           # este arquivo
├── .gitignore
└── skills/
    ├── l-spec/SKILL.md                 # hub — overview, auto-sizing, regras
    ├── l-spec-discovery/SKILL.md
    ├── l-spec-feature-clarify/SKILL.md
    ├── l-spec-specify/SKILL.md
    ├── l-spec-discuss/SKILL.md
    ├── l-spec-design/SKILL.md
    ├── l-spec-tasks/SKILL.md
    ├── l-spec-execute/SKILL.md
    ├── l-spec-bugfix/SKILL.md
    ├── l-spec-ask/SKILL.md
    ├── l-spec-map/SKILL.md
    ├── l-spec-pause/SKILL.md
    ├── l-spec-resume/SKILL.md
    ├── l-spec-next/SKILL.md
    ├── l-spec-auto/SKILL.md
    └── l-spec-help/SKILL.md
```
...
|---------|-------------|
| `/skill:l-spec-discovery` | **Start a new project.** 22 questions, 6 phases — vision, scope, stack, design refs, risks, milestones |
| `/skill:l-spec-feature-clarify` | **Add feature to existing project.** 5 rapid questions before specifying |
| `/skill:l-spec-specify` | **Define WHAT to build.** Testable requirements (FEAT-01, FEAT-02...) |
| `/skill:l-spec-discuss` | Capture user decisions on gray areas / trade-offs |
| `/skill:l-spec-design` | **Define HOW —** architecture, components. Auto-skipped for simple changes |
...
| `/skill:l-spec-ask` | **Ask about existing code.** Explain, summarize, trace — no planning, just understanding |
...
| `/skill:l-spec-help` | List all commands with descriptions |
...
Ou manualmente: remove `~/.pi/agent/skills/l-spec*/` e `~/.pi/agent/prompts/lspec-*.md`.
