...
Provides 9 specialized agents with **per-role model AND provider assignment** — each task runs on whatever LLM makes sense, not just whatever you're currently chatting with:
